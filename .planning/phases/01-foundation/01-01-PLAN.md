...
7. Update types/database.types.ts with:
...
1. Deploy function: `supabase functions deploy push`
2. Set EXPO_ACCESS_TOKEN secret: `supabase secrets set EXPO_ACCESS_TOKEN=<token>`
3. Create database webhook in Supabase dashboard pointing to this function on user_notifications INSERT
  </action>
  <verify>
