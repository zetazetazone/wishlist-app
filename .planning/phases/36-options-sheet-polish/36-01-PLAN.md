...
6. **Action buttons** (Pressable with pressed state styling):
   ...
   - **Edit**: pencil icon, `t('common.edit')` label. Shows Alert.alert with "Coming soon" message (edit form doesn't exist yet). NOTE: Do NOT navigate to non-existent route - show alert instead.
