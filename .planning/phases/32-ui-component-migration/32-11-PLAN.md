...
2. For CountdownCard.tsx:
   - Add imports and hook
   - This is where countdown text translation connects
   - Pass t function to getCountdownText (will be updated in Plan 12):
     ```typescript
     // For now, translate the standard countdown phrases directly:
